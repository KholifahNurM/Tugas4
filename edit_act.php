    ...
    if ($foto_size > 2097152) {
       ...
       if ($foto_nama != "") {
          ...
          if(in_array($ekstensi, $ekstensi_izin) === true)  {
            ...
            $query = mysqli_query($koneksi, "UPDATE mahasiswa SET NIM='$id',nama='$nama', email='$email', jurusan='$jurusan',fakultas='$fakultas', gambar='$foto_nama_new' WHERE NIM='$id'");
    	...
    	// Apabila tidak ada file yang diupload maka akan menjalankan code dibawah ini
          $query = mysqli_query($koneksi, "UPDATE mahasiswa SET NIM='$id',nama='$nama', email='$email', jurusan='$jurusan', fakultas='$fakultas' WHERE NIM='$id'");
